...
namespace Lrn\MagazineBundle\Controller;
...
use Lrn\MagazineBundle\Entity\Issue;
use Lrn\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LrnMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("LrnMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LrnMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LrnMagazineBundle:Issue:edit.html.twig")
     */
