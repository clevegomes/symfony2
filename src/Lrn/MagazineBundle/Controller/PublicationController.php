...
use Lrn\MagazineBundle\Entity\Publication;
use Lrn\MagazineBundle\Form\PublicationType;
...
//            ->findUserByUsername('cleve');
     ...
     * @Method("POST")
     * @Template("LrnMagazineBundle:Publication:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LrnMagazineBundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LrnMagazineBundle:Publication:edit.html.twig")
     */
